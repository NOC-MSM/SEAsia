...
#::
  ...
  # you can download the ORCA R12 coordinates or in ARCHER you can take it from
  #  my directory
  cp /work/n01/n01/$USER/EXTRA_TOOLS/GRIDS/coordinates_ORCA_R12.nc $TDIR/NESTING/.
