...
!  I/O 
!-----------------------------------------------------------------------
   sn_src_dir = 'NCML/ORCA0083_N06_1970.ncml'       ! src_files/'
   sn_dst_dir = '/projectsa/accord/SEAsia/INPUTS/OBC/1961-1969/'
...
!  Time information
!-----------------------------------------------------------------------
    nn_year_000     = 1970        !  year start
    nn_year_end     = 1970          !  year end
