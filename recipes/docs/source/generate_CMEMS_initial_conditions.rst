...
.. Note: I am not sure why we prefer enhanced vertical diffusion over
 non-penetrative convection. I can imagine it could have something to do with
 calculating budgets, which would be easier with a diffusion term. Anyway I am
 minded to switch to non-penetrative convection if this problem emerges at the
 boundaries too...
