Changing namelist_cfg from v3.6 to v4
=====================================

Some notes and observations about changing between namelist formats. (These were
mostly found when configuring a course Liverpool Bay test configuration).
